...
- **M2 本実装中**（業務知識 v4 のフロー実装フェーズ）
- Backend Cloud Run + `https://api.vrc-photobook.com` で疎通済み（DB あり、HTTPS、Google Trust Services 証明書）
- Frontend Workers deploy / `app.vrc-photobook.com` Custom Domain は **準備前**
- 詳細・現在地マーカー: [`harness/work-logs/2026-04-27_post-deploy-final-roadmap.md`](./harness/work-logs/2026-04-27_post-deploy-final-roadmap.md)
...
| **現在地ロードマップ** | [`harness/work-logs/2026-04-27_post-deploy-final-roadmap.md`](./harness/work-logs/2026-04-27_post-deploy-final-roadmap.md) |
...
| Cloud SQL instance | `vrcpb-api-verify`（短期検証用、PR17 後に残置/削除を再判断） |
| Workers project | `vrcpb-frontend`（PR14 で deploy 予定） |
