...
//   - raw session token / draft_edit_token / manage_url_token を含めない
//   - session_token_hash の base64url 表現を含めない
...
//
// PR2 では基本ハンドラの構築のみ。禁止フィールドの中央マスキング middleware は
// PR3 以降（auth / DB アクセスを伴う段階）で追加する。
package shared
